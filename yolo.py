...
from models.TripletAttention import *
from models.MobileViTmodels import *
from models.MobileViTv2Attention import *
from models.ExternalAttention import *
from models.EffectiveSE import *
from models.EMA import *
from models.LSKBlock import *
from models.EfficientAttention import *
from models.S2Attention import *
from models.gc import *
from models.GE import *
from models.MobileViTAttention import *
    ...
    def forward(self, x):
        ...
        for i in range(self.nl):
            ...
            if not self.training:  # inference
                ...
                if isinstance(self, Decoupled_Detect): 
...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in (Conv, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF, DWConv, MixConv2d, Focus, CrossConv,
                 BottleneckCSP, C3, C3TR, C3SPP, C3Ghost, nn.ConvTranspose2d, DWConvTranspose2d, C3x, C3_DCNV3, DCNV3_YoLo, MV2Block, MobileViTBlock, C2f):
            c1, c2 = ch[f], args[0]
            if c2 != no:  # if not output
                c2 = make_divisible(c2 * gw, 8)

            args = [c1, c2, *args[1:]]
            if m in [BottleneckCSP, C3, C3TR, C3Ghost, C3x, C3_DCNV3, C2f]:
        ...
        elif m in [MobileViTAttention, GatherExcite, EfficientAttention, GlobalContext, S2Attention, EMA, LSKblock, EffectiveSEModule]:
            args = [ch[f], *args]

        elif m in [ExternalAttention, MobileViTv2Attention, TripletAttention]:
            args = [ch[f], *args]
